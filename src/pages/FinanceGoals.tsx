          ...
          <tbody>
            {sortedGoals.map(g => (
              ...
              >
                ...
                <td><input type="text" className="grid-cell-input" value={g.name} placeholder="Goal name" title="What this savings goal is called — shows up under this name on the Dashboard and in Cash Flow Summary's Savings line." onChange={e => patch(g, { name: e.target.value })} /></td>
                <td>
