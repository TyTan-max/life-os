    ...
    <>
      <CollectionPage<Movie>
        ...
        fields={[
          ...
          { key: 'currentSeason', label: 'Current Season', type: 'number', placeholder: 'TV only' },
          { key: 'currentEpisode', label: 'Current Episode', type: 'number', placeholder: 'Within that season — TV only' },
        ...
        numberSortKey="runtimeMin"
        numberSortLabel="runtime"
        autofill={{
          titleKey: 'title',
