...
const PARA_TABS: ParaTab[] = ['Books', 'Overview', 'All', 'Inbox', 'Tasks', 'Goals', 'Projects', 'Areas', 'Archive', 'Flashcards'];
            ...
            <>
              ...
              {(note.images ?? []).length > 0 && (
                <div className="sb-backlinks sb-photos-panel">
                  <button type="button" className="sb-backlinks-head" onClick={() => setPhotosOpen(o => !o)}>
                    <h3>Photos ({(note.images ?? []).length})</h3>
                    <ChevronDown size={14} className={`sb-backlinks-chevron ${photosOpen ? 'open' : ''}`} />
                  </button>
                  {photosOpen && (
              ...
              {backlinks.length > 0 && (
                <div className="sb-backlinks">
                  <button type="button" className="sb-backlinks-head" onClick={() => setLinkedMentionsOpen(o => !o)}>
                    <h3>Linked mentions ({backlinks.length})</h3>
                    <ChevronDown size={14} className={`sb-backlinks-chevron ${linkedMentionsOpen ? 'open' : ''}`} />
                  </button>
                  {linkedMentionsOpen && backlinks.map(b => (
